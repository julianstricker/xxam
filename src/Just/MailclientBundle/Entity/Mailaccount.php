...
namespace Just\MailclientBundle\Entity;
...
class Mailaccount implements Base\TenantInterface
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Just\UserBundle\Entity\User", mappedBy="mailaccounts")
     ...
     * Add users
     *
     * @param \Just\UserBundle\Entity\User $users
     * @return Mailaccount
     */
    public function addUser(\Just\UserBundle\Entity\User $users)
    {
        $this->users[] = $users;
     ...
     * @param \Just\UserBundle\Entity\User $users
     */
    public function removeUser(\Just\UserBundle\Entity\User $users)
    {
