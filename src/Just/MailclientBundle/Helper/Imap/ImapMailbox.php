...
namespace Just\MailclientBundle\Helper\Imap;

use Just\MailclientBundle\Helper\Imap\ImapMailboxException;
use Just\MailclientBundle\Helper\Imap\IncomingMail;
use Just\MailclientBundle\Helper\Imap\IncomingMailAttachment;
...
class ImapMailbox {
     ...
     * @return array Mails ids
     */
    public function sortMails($criteria = SORTARRIVAL, $reverse = true, $searchcriteria) {
    ...
    protected function initMailPart(IncomingMail $mail, $partStructure, $partNum, $markAsSeen = true) {
        ...
        if ($attachmentId) {
            ...
            if ($this->attachmentsDir) {
                ...
                $attachment->fileSize=filesize($attachment->filePath);
            }
