 ...
 *     })
 * @ORM\Entity(repositoryClass="Just\UserBundle\Entity\GroupRepository")
 */
class Group extends BaseGroup implements Base\TenantInterface
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Just\FilemanagerBundle\Entity\Filesystem", inversedBy="groups")
