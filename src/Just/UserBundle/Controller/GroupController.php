...
use Just\UserBundle\Form\Type\GroupType;
...
class GroupController extends Controller
{
    ...
    public function searchgroupsAction(Request $request)
    {
        ...
        $query = $em->getRepository('JustUserBundle:Group')->createQueryBuilder('e');
    ...
    public function indexAction() {
        $repository=$this->getDoctrine()->getManager()->getRepository('JustUserBundle:Group');
        return $this->render('JustUserBundle:Group:index.js.twig', array('modelfields'=>$repository->getModelFields(),'gridcolumns'=>$repository->getGridColumns()));
    }
     ...
     * @Method("POST")
     * @Template("JustUserBundle:Group:new.html.twig")
     */
...
//        $em = $this->getDoctrine()->getManager();
//
//        $entity = $em->getRepository('JustUserBundle:Group')->find($id);
//
//        if (!$entity) {
//            throw $this->createNotFoundException('Unable to find Group entity.');
//        }
...
//    }
     ...
     * @Method("PUT")
     * @Template("JustUserBundle:Group:edit.html.twig")
     */
