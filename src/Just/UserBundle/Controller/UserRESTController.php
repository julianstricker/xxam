...
use Just\UserBundle\Form\UserType;
...
class UserRESTController extends VoryxController
{
    ...
    public function cgetAction(ParamFetcherInterface $paramFetcher)
    {
        try {
            ...
            $entities = $em->getRepository('JustUserBundle:User')->findBy($filters, $order_by, $limit, $offset);
            if ($entities) {
                //total:
                $total = $em->getRepository('JustUserBundle:User')->getTotalcount($filters);
                $results=Array();
