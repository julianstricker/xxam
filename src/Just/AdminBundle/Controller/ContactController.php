...
{ 
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('JustAdminBundle:Contact')->findAll();
     ...
     * @Method("POST")
     * @Template("JustAdminBundle:Contact:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('JustAdminBundle:Contact')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("JustAdminBundle:Contact:edit.html.twig")
     */
