/**
 * @class Ext.contact.ContactPanel
 * @extends Ext.Panel
 * <p>This is the default container for Ext contact views. It supports day, week and month views as well
 * as a built-in event edit form. The only requirement for displaying a contact is passing in a valid
 * {@link #contactStore} config containing records of type {@link Ext.contact.EventRecord EventRecord}. In order
 * to make the contact interactive (enable editing, drag/drop, etc.) you can handle any of the various
 * events fired by the underlying views and exposed through the ContactPanel.</p>
 * {@link #layoutConfig} option if needed.</p>
 * @constructor
 * @param {Object} config The config object
 * @xtype contactpanel
 */
Ext.define('Ext.contact.ContactPanel', {
    extend: 'Ext.panel.Panel',
    alias: ['widget.contactpanel','widget.just.justcontact.js.contactpanel'],
    
    requires: [
        'Ext.layout.container.Card',
        'Ext.contact.view.Day',
        'Ext.contact.view.Week',
        'Ext.contact.view.Month',
        'Ext.contact.form.EventDetails',
        'Ext.contact.data.EventMappings'
    ],
     ...
     * True to display the contact navigation toolbar, false to hide it (defaults to true). Note that
     * if you hide the default navigation toolbar you'll have to provide an alternate means of navigating the contact.
     */
    showNavBar: true,
    /**
     ...
     * True to show the value of {@link #todayText} instead of today's date in the contact's current day box,
     * false to display the day number(defaults to true).
     */
    showTodayText: true,
    /**
     * @cfg {Boolean} showTime
     * True to display the current time next to the date in the contact's current day box, false to not show it 
     * (defaults to true).
     */
    showTime: true,
    /**
     ...
     * @param {Ext.contact.ContactPanel} this
     * @param {Ext.contact.EventRecord} rec The new {@link Ext.contact.EventRecord record} that was added
     */
     ...
     * @param {Ext.contact.ContactPanel} this
     * @param {Ext.contact.EventRecord} rec The new {@link Ext.contact.EventRecord record} that was updated
     */
     ...
     * @param {Ext.contact.ContactPanel} this
     * @param {Ext.contact.EventRecord} rec The new {@link Ext.contact.EventRecord record} that was removed
     */
     ...
     * @param {Ext.contact.ContactPanel} this
     * @param {Ext.contact.EventRecord} rec The new {@link Ext.contact.EventRecord record} that was canceled
     */

    /**
     * @event viewchange
     * Fires after a different contact view is activated (but not when the event edit form is activated)
     * @param {Ext.contact.ContactPanel} this
     * @param {Ext.Ext.contact.view.AbstractContact} view The view being activated (any valid {@link Ext.contact.view.AbstractContact AbstractContact} subclass)
    ...
    //
    // NOTE: ContactPanel also relays the following events from contained views as if they originated from this:
    //
    /**
     ...
     * @param {Ext.contact.ContactPanel} this
     * @param {Ext.contact.EventRecord} rec The {@link Ext.contact.EventRecord record} for the event that was clicked on
     ...
     * @param {Ext.contact.ContactPanel} this
     * @param {Ext.contact.EventRecord} rec The {@link Ext.contact.EventRecord record} for the event that the cursor is over
     ...
     * @param {Ext.contact.ContactPanel} this
     * @param {Ext.contact.EventRecord} rec The {@link Ext.contact.EventRecord record} for the event that the cursor exited
    ...
    /**
     * @event rangeselect
     * Fires after the user drags on the contact to select a range of dates/times in which to create an event
     * @param {Ext.contact.ContactPanel} this
     ...
     * @param {Ext.contact.ContactPanel} this
     * @param {Ext.contact.EventRecord} rec The {@link Ext.contact.EventRecord record} for the event that was moved with
     ...
     * @param {Ext.contact.ContactPanel} this
     * @param {Ext.contact.EventRecord} rec The {@link Ext.contact.EventRecord record} for the event that was resized
    ...
    onEventAdd: function(form, rec) {
        rec.data[Ext.contact.data.EventMappings.IsNew.name] = false;
        this.hideEditForm();
     ...
     * hides the contact views and navigation toolbar.  To return to the contact, call {@link #hideEditForm}.
     * @param {Ext.contact.EventRecord} record The event record to edit
     * @return {Ext.contact.ContactPanel} this
     */
    ...
    /**
     * Hides the built-in event edit form and returns to the previous contact view. If the edit form is
    ...
    /**
     * Sets the start date for the currently-active contact view.
     * @param {Date} dt
     */
    ...
    /**
     * Return the contact view that is currently active, which will be a subclass of
     * {@link Ext.contact.view.AbstractContact AbstractContact}.
     * @return {Ext.contact.view.AbstractContact} The active view
     */
