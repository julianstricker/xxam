...
namespace Just\FilemanagerBundle\Entity;
 ...
 *     })
 * @ORM\Entity(repositoryClass="Just\FilemanagerBundle\Entity\FilesystemRepository")
 */
class Filesystem implements Base\TenantInterface
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Just\UserBundle\Entity\User", inversedBy="filesystems")
     * @ORM\JoinColumn(name="user_id", referencedColumnName="id")
     */
    private $user;
    
    /**
     * @ORM\ManyToMany(targetEntity="Just\UserBundle\Entity\Group", mappedBy="filesystems")
     ...
     * Set user
     *
     * @param \Just\UserBundle\Entity\User $user
     * @return Filesystem
     */
    public function setUser(\Just\UserBundle\Entity\User $user = null)
    {
        $this->user = $user;
     ...
     * Get user
     *
     * @return \Just\UserBundle\Entity\User 
     */
     ...
     * Add groups
     *
     * @param \Just\UserBundle\Entity\Group $groups
     * @return Filesystem
     */
    public function addGroup(\Just\UserBundle\Entity\Group $groups)
    {
        $this->groups[] = $groups;
     ...
     * @param \Just\UserBundle\Entity\Group $groups
     */
    public function removeGroup(\Just\UserBundle\Entity\Group $groups)
    {
