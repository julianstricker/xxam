...
use Just\FilemanagerBundle\Form\FilesystemType;
...
class FilemanagerRESTController extends VoryxController
{
    ...
    public function cgetAction(ParamFetcherInterface $paramFetcher)
    {
        try {
            ...
            $entities = $em->getRepository('JustFilemanagerBundle:Filesystem')->findBy($filters, $order_by, $limit, $offset);
            if ($entities) {
                //total:
                $total = $em->getRepository('JustFilemanagerBundle:Filesystem')->getTotalcount($filters);
                $results=Array();
