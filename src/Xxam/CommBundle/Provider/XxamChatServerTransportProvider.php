 ...
 */
class XxamChatServerTransportProvider extends AbstractTransportProvider implements MessageComponentInterface, WsServerInterface
{
     ...
     */
    public function __construct($address = "127.0.0.1", $port = 8080,$container)
    {
        $this->peer       = null;
        $this->port       = $port;
     ...
     *
     * @return array
     * @temporary This method may be removed in future version (note that will not break code, xxam make some code obsolete)
     */
     ...
     *
     * @param  \Ratchet\ConnectionInterface $conn The socket/connection that xxam connected to your application
     * @throws \Exception
     */
