...
class DynmodRepository extends EntityRepository
{
    ...
    public function getModelFields(){
        ...
        $fields[]=Array('name'=> 'additionalroles');
        $fields[]=Array('name'=> 'active','type'=>'boolean');
    ...
    public function getGridColumns(){
        ...
        $columns[]=Array('text'=> 'Active','flex'=> 1,'dataIndex'=> 'active', 'xtype'=> 'checkcolumn', 'filter'=> Array('type'=> 'boolean'));
