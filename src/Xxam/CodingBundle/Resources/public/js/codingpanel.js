/**
 * @class Ext.coding.CodingPanel
 * @extends Ext.Panel
 * <p>This is the default container for Ext coding views. It supports day, week and month views as well
 * as a built-in event edit form. The only requirement for displaying a coding is passing in a valid
 * {@link #codingStore} config containing records of type {@link Ext.coding.EventRecord EventRecord}. In order
 * to make the coding interactive (enable editing, drag/drop, etc.) you can handle any of the various
 * events fired by the underlying views and exposed through the CodingPanel.</p>
 * {@link #layoutConfig} option if needed.</p>
 * @constructor
 * @param {Object} config The config object
 * @xtype codingpanel
 */
Ext.define('Ext.coding.CodingPanel', {
    extend: 'Ext.panel.Panel',
    alias: ['widget.codingpanel','widget.xxam.xxamcoding.js.codingpanel'],
    
    requires: [
        'Ext.layout.container.Card',
        'Ext.coding.view.Day',
        'Ext.coding.view.Week',
        'Ext.coding.view.Month',
        'Ext.coding.form.EventDetails',
        'Ext.coding.data.EventMappings'
    ],
     ...
     * True to display the coding navigation toolbar, false to hide it (defaults to true). Note that
     * if you hide the default navigation toolbar you'll have to provide an alternate means of navigating the coding.
     */
    showNavBar: true,
    /**
     ...
     * True to show the value of {@link #todayText} instead of today's date in the coding's current day box,
     * false to display the day number(defaults to true).
     */
    showTodayText: true,
    /**
     * @cfg {Boolean} showTime
     * True to display the current time next to the date in the coding's current day box, false to not show it 
     * (defaults to true).
     */
    showTime: true,
    /**
     ...
     * @param {Ext.coding.CodingPanel} this
     * @param {Ext.coding.EventRecord} rec The new {@link Ext.coding.EventRecord record} that was added
     */
     ...
     * @param {Ext.coding.CodingPanel} this
     * @param {Ext.coding.EventRecord} rec The new {@link Ext.coding.EventRecord record} that was updated
     */
     ...
     * @param {Ext.coding.CodingPanel} this
     * @param {Ext.coding.EventRecord} rec The new {@link Ext.coding.EventRecord record} that was removed
     */
     ...
     * @param {Ext.coding.CodingPanel} this
     * @param {Ext.coding.EventRecord} rec The new {@link Ext.coding.EventRecord record} that was canceled
     */

    /**
     * @event viewchange
     * Fires after a different coding view is activated (but not when the event edit form is activated)
     * @param {Ext.coding.CodingPanel} this
     * @param {Ext.Ext.coding.view.AbstractCoding} view The view being activated (any valid {@link Ext.coding.view.AbstractCoding AbstractCoding} subclass)
    ...
    //
    // NOTE: CodingPanel also relays the following events from contained views as if they originated from this:
    //
    /**
     ...
     * @param {Ext.coding.CodingPanel} this
     * @param {Ext.coding.EventRecord} rec The {@link Ext.coding.EventRecord record} for the event that was clicked on
     ...
     * @param {Ext.coding.CodingPanel} this
     * @param {Ext.coding.EventRecord} rec The {@link Ext.coding.EventRecord record} for the event that the cursor is over
     ...
     * @param {Ext.coding.CodingPanel} this
     * @param {Ext.coding.EventRecord} rec The {@link Ext.coding.EventRecord record} for the event that the cursor exited
    ...
    /**
     * @event rangeselect
     * Fires after the user drags on the coding to select a range of dates/times in which to create an event
     * @param {Ext.coding.CodingPanel} this
     ...
     * @param {Ext.coding.CodingPanel} this
     * @param {Ext.coding.EventRecord} rec The {@link Ext.coding.EventRecord record} for the event that was moved with
     ...
     * @param {Ext.coding.CodingPanel} this
     * @param {Ext.coding.EventRecord} rec The {@link Ext.coding.EventRecord record} for the event that was resized
    ...
    onEventAdd: function(form, rec) {
        rec.data[Ext.coding.data.EventMappings.IsNew.name] = false;
        this.hideEditForm();
     ...
     * hides the coding views and navigation toolbar.  To return to the coding, call {@link #hideEditForm}.
     * @param {Ext.coding.EventRecord} record The event record to edit
     * @return {Ext.coding.CodingPanel} this
     */
    ...
    /**
     * Hides the built-in event edit form and returns to the previous coding view. If the edit form is
    ...
    /**
     * Sets the start date for the currently-active coding view.
     * @param {Date} dt
     */
    ...
    /**
     * Return the coding view that is currently active, which will be a subclass of
     * {@link Ext.coding.view.AbstractCoding AbstractCoding}.
     * @return {Ext.coding.view.AbstractCoding} The active view
     */
